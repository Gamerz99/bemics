...
<div id="page">
        ...
        <nav class="colorlib-nav " role="navigation">
            <div class="top-menu nav-menu">
                <div class="container">
                    <div class="row">
                        <div class="col-md-2">
                            <div id="colorlib-logo"><a href="<?php echo base_url(); ?>home">Bemics</a></div>
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6 text-center animate-box">
                        <div class="counter-entry">
                            <div class="desc">
                                ...
                                <span class="colorlib-counter-label">Designs</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6 text-center animate-box">
                        <div class="counter-entry">
                            <div class="desc">
                                ...
                                <span class="colorlib-counter-label">Companies</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6 text-center animate-box">
    ...
    <div id="colorlib-testimony" class="testimony-img" style="background-image: url(<?php echo base_url(); ?>flayout/images/content/intro-img-2.jpg);" data-stellar-background-ratio="0.5">
        <div class="overlay"></div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
